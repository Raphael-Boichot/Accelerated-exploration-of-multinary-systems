...
We know:
    - :math:`E_S, \nu_S` : elastic modulus and Poisson coefficient of the sample
    - :math:`E_i, \nu_i`: elastic modulus and Poisson coefficient of indenter
    - :math:`H`: hardness of the sample
    - :math:`\cot \gamma_i=\sqrt[4]{\frac{\pi^{2}}{27}} \cot \gamma_{B}` with :math:`\gamma_{B}=65\°` for berkovitch indenter
From:
.. math::  
    - E_i^*=\frac{E_i}{1-\nu_i**2}
    - Ks=\frac{E_s}{3(1-2\nu_s)}
