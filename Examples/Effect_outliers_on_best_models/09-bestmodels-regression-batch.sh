...
#SBATCH --job-name="pyterk09r"                        # nom du job
...
NOTEBOOK_DIR="$ALL_CCFRWORK/pyterk/Elise/Effect_outliers_on_best_models"


NOTEBOOK_SRC1="09-bestmodels-regression-run.ipynb"
NOTEBOOK_SRC2="09-bestmodels-regresssion-report.ipynb"
